			...
			public void onClick(View v) {
				...
				try {
					...
					txtMemberedDetails.setText("Membered Details"
							...
							+ "\nRegister Date : " +  DateManager.getDateString(customer.getRegisterDate()));
					...
					alertDialog1.setButton("OK",
							new DialogInterface.OnClickListener() {
								...
								public void onClick(DialogInterface dialog,
									...
									String message="Thank You "+sale.getCustomer().getName()+" For Shopping";
									message+=	"Item List : " + sale.getItems().toString()+
												"\nPrice : " + sale.getPayment().getPrice();
